...
<#assign session = (Session.login)!""/>	
			...
			<div class="col-md-4 offset-md-3">
				<div class="card reg-top">
					...
					<div class="card-body">
						...
						<form name="reg" id="reg" method="post" action="<#if session?has_content>update<#else>insertUser</#if>" onsubmit="return validate()" enctype="multipart/form-data">
			 	...
			 	<#if userModel?has_content>
					...
					<div id="example1" class="form-group">	
						...
						<#assign count_Validate++>
							...
							<#if session?has_content>							
							<a class="btn btn-outline-light btn-lg login-btn-width login-bg" id="cancle"
	...
	<#--  	document.getElementById('userId').value= user.id; -->
        ...
        document.getElementById("m_no").value= user.m_no;
		...
		for(var i = 0; i < language_array.length; i++) {
		   document.getElementById(language_array[i]).checked= true;
		}
        
		document.getElementById('hobbie').value= user.hobbie;
        document.getElementById("password").value= user.password;
        document.getElementById("cpwd").value= user.password;
        
        localStorage.clear();
        <#-- document.getElementById("preview").src = user.pic; -->
	</script>
